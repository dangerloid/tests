                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img1.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img2.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img3.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img4.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img5.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     <div class="blog-box mt-2 mb-2">
                        <div class="row no-gutters row-eq-height pb-4">
                           ...
                           <div class="col-sm-6">
                              <img class="img-fluid w-100" src="images/blog/blog-img6.jpg" alt="image">
                           </div>
                        </div>
                     </div>
                  </div>
